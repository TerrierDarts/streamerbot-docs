<!--
  Taken from `@nuxt-themes/docus/components/layouts/DocsLayout.vue`
  Modified to sort aside nav by semver descending and auto archive old versions
-->
